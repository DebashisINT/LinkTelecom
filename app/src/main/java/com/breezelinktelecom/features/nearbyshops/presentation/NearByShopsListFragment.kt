...
import com.breezelinktelecom.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezelinktelecom.app.utils.FTStorageUtils
import com.breezelinktelecom.app.utils.NotificationUtils
...
import com.breezelinktelecom.features.addshop.model.AssignedToShopListResponseModel
import com.breezelinktelecom.features.addshop.model.QuestionSubmit
...
import com.breezelinktelecom.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
...
import com.breezelinktelecom.features.nearbyshops.model.StageListResponseModel
...
import com.breezelinktelecom.features.shopdetail.presentation.AddCollectionDialog
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezelinktelecomApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
