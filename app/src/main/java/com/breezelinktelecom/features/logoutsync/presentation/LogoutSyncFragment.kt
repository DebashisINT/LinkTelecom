package com.breezelinktelecom.features.logoutsync.presentation
...
import com.breezelinktelecom.app.utils.Toaster
import com.breezelinktelecom.base.BaseResponse
import com.breezelinktelecom.base.presentation.BaseActivity
import com.breezelinktelecom.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezelinktelecom.features.billing.api.AddBillingRepoProvider
import com.breezelinktelecom.features.billing.model.AddBillingInputParamsModel
...
import com.breezelinktelecom.features.dashboard.presentation.ReasonDialog
...
import com.breezelinktelecom.features.document.model.DocumentAttachmentModel
...
import com.breezelinktelecom.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezelinktelecom.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezelinktelecom.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezelinktelecom.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezelinktelecom.features.orderhistory.model.*
...
import com.breezelinktelecom.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezelinktelecom.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezelinktelecom.features.timesheet.model.AddTimeSheetInputModel
...
import com.breezelinktelecom.MonitorService
import com.breezelinktelecom.MySingleton
import com.breezelinktelecom.app.AlarmReceiver
import com.breezelinktelecom.features.addshop.model.*
import com.breezelinktelecom.features.addshop.model.assigntopplist.AddShopUploadImg
...
import com.breezelinktelecom.features.login.model.GetConcurrentUserResponse
...
import com.breezelinktelecom.features.orderITC.SyncDeleteOpptL
import com.breezelinktelecom.features.orderITC.SyncEditOppt
import com.breezelinktelecom.features.orderITC.SyncOppt
import com.breezelinktelecom.features.orderITC.SyncOpptProductL
import com.breezelinktelecom.features.orderITC.SyncOrd
import com.breezelinktelecom.features.orderITC.SyncOrdProductL
import com.breezelinktelecom.features.performance.model.Gps_status_list
import com.breezelinktelecom.features.performance.model.UpdateGpsInputListParamsModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezelinktelecomlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezelinktelecomlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezelinktelecomlogsample/log.zip").path);
