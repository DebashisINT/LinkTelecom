package com.breezelinktelecom.features.commondialogsinglebtn
...
import com.breezelinktelecom.app.domain.ShopVisitCompetetorModelEntity
import com.breezelinktelecom.app.domain.VisitRemarksEntity
...
import com.breezelinktelecom.features.addshop.presentation.ProspectListDialog
import com.breezelinktelecom.features.dashboard.presentation.DashboardActivity
import com.breezelinktelecom.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezelinktelecom.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezelinktelecom/files", "recorded_audio${System.currentTimeMillis()}.mp3")
